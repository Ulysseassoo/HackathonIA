...
const Profile = () => {
  ...
  const { agents, isLoading: agentsLoading, createAgent, deleteAgent, isCreating, isDeleting } = useAgents()
                  ...
                  <form onSubmit={handleAddAgent} className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) => setNewAgent({...newAgent, tags: e.target.value.split(',').map(tag => tag.trim()).filter(tag => tag)})}
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex space-x-2 ml-4">
                          <Button variant="outline" size="sm" className="border-serenity-blue text-serenity-blue hover:bg-serenity-blue hover:text-white">
