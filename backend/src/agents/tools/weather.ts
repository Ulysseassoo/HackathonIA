...
export const weather = tool(
  ...
  },
  {
    name: 'weather',
    description:
      'Obtient les informations météo en temps réel pour une ville donnée (service gratuit sans clé API)',
    schema: z.object({
      ville: z
        .string()
        .describe(
          'Le nom de la ville pour laquelle obtenir la météo (ex: Paris, London, Tokyo)',
        ),
    }),
  },
);
